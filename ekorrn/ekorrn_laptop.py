...
print(notes)
melody = pg.image.load("melody2.png")
melody.convert()
piano = pg.image.load("piano.png")
piano.convert()
well_played = pg.image.load("well-played.png")
well_played.convert()
...
while run:
    ...
    pg.draw.rect(screen, (11, 218, 81), (500+207,300,positions[pos], 100))
    screen.blit(melody, (500,20))
    if klar:
        screen.blit(well_played, (450, 270))
    else:
    ...
    for i in range(len(notes)):
        if currently_playing[i]:
            ...
            if all_notes[i][-1] == "#":
                pg.draw.circle(screen, (95, 133, 117), (400+coords[i], 760), 12)
            else:
                pg.draw.circle(screen, (193, 225, 193), (400+coords[i], 920), 25)
